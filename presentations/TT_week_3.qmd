...
| Placebo test | Seems like standard practice to see if there's anticipated behaviour | Event study pre-period coefficients are insignificant — I assume placebo tests only add value for static DiD |