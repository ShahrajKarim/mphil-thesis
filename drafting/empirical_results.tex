...
The triple-difference estimates reveal substantial heterogeneity across therapeutic areas. Significant negative responses are observed in patenting behaviour for alimentary tract and metabolism, cardiovascular, musculo-skeletal, and nervous system drugs. Since RQ1 identifies an aggregate decline in patenting following the Medicaid expansion, these classes appear to drive that overall result. These are among the highest-volume therapeutic areas within Medicaid and cover widely prescribed drug categories such as diabetes and gastrointestinal medications, anti-inflammatories and antidepressants. As shown later in the theoretical model, and in the NDC counts in Table~\ref{tab:class_substitutability}, these classes typically have greater therapeutic substitutability, consistent with stronger formulary competition and rebate pressure. Consequently, this combination of high prescription volumes and stronger substitutability is consistent with the procurement channel driving deeper innovation reductions in these areas.

Positive patenting responses are observed for blood and blood-forming organs, hormonal preparations, and sensory organs. This is consistent with the standard market size prediction for these therapeutic classes, suggesting the demand effect outweighs the disincentives associated with Medicaid's procurement channel. Insignificant coefficients are observed for the remaining therapeutic classes suggesting the demand and procurement effects offset one another, or the expansion may be unimportant for patenting decisions in these areas. The ex-post specification yields comparable results

The presence of positive class-level estimates indicates that some therapeutic areas experience a demand-driven innovation response, suggesting that the standard market-size effect is not absent in the Medicaid setting. Instead, the aggregate negative patenting response identified in RQ1 is concentrated in therapeutic classes where high prescription volumes and therapeutic substitutability strengthen the procurement channel. Therefore, the overall decline in patenting reflects the two  opposing forces operating differentially across therapeutic areas, rather than a uniform reduction in pharmaceutical innovation.
...
% -----------------------------------------------------------------------
\section{Therapeutic-Class Substitutability}
% -----------------------------------------------------------------------
