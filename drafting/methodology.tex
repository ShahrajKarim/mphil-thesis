...
=
\frac{
\sum_{d} \mathbf{1}\{d \in f, c\} \cdot \mathbf{1}\{d \in \text{PDL}\}
}{
\sum_{d} \mathbf{1}\{d \in f, c\}
}
\end{equation}
...
\begin{equation}
\text{PT\_Pass}_{f,c} = \frac{\sum_{d} \mathbf{1}\{d \in f, c\} \cdot \mathbf{1}\{\text{PT\_Stage\_Pass}_d = 1\}}{\sum_{d} \mathbf{1}\{d \in f, c\}}
\end{equation}

\begin{equation}
\text{Price\_Pass}_{f,c} = \frac{\sum_{d} \mathbf{1}\{d \in f, c\} \cdot \mathbf{1}\{\text{Price\_Stage\_Pass}_d = 1\}}{\sum_{d} \mathbf{1}\{d \in f, c\}}
\end{equation}
