...
PDL exposure is constructed as a predetermined measure of a firm's positioning within Medicaid's formulary, and since Texas did not opt for the Medicaid expansion, contamination of this measure from the ACA is unlikely.
...
\end{equation}
where $a$ is a specific ATC within the universe of ATC Level 1 therapeutic areas $\mathcal{A}$, and $\theta_a$ captures the post-2014 differential response associated with Medicaid exposure in therapeutic area $a$. Firm and class effects are separated in this specification due to computational constraints associated with the larger number of interaction terms. These estimates provide evidence on the heterogeneity of the response to the ACA and help assess whether the aggregate results are driven by particular therapeutic areas.
