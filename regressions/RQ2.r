...
save_iplot(fda_rq2_feols_exante, "fda_feols_exante.png",
           "FEOLS: FDA approvals (ex-ante, with PDL)")
save_iplot(fda_rq2_feols_expost, "fda_feols_expost.png",
           "FEOLS: FDA approvals (ex-post, with PDL)")
...
save_iplot(patent_rq2_feols_exante, "patent_feols_exante.png",
           "FEOLS: Patents (ex-ante, with PDL)")
